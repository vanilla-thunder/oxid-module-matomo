...
$aModule = [
	...
	'settings'    => [
		...
		[
			'group' => 'blaMatomo_Main',
			'name'  => 'blaMatomo_sToken',
			'type'  => 'str',
			'value' => ''
		],
		[
			'group' => 'blaMatomo_Main',
			'name'  => 'blaMatomo_iSiteID',
			'type'  => 'str',
			'value' => ''
		],
		...
		[
			'group' => 'blaMatomo_Main',
			'name'  => 'blaMatomo_blEnableJSErrorTrackin',
			'type'  => 'bool',
			'value' => true
		],
		[
			'group' => 'blaMatomo_Main',
			'name'  => 'blaMatomo_blFirstReferrerConv',
			'type'  => 'bool',
			'value' => false
		],
		// Benutzerdefinierte Dimensionen
		[
			'group' => 'blaMatomo_CustomDimensions',
			'name'  => 'blaMatomo_iLanguageDimension',
			'type'  => 'str',
			'value' => '1'
		],
		[
			'group' => 'blaMatomo_CustomDimensions',
			'name'  => 'blaMatomo_iPaymentDimension',
			'type'  => 'str',
			'value' => '2'
		],
		[
			'group' => 'blaMatomo_CustomDimensions',
			'name'  => 'blaMatomo_iDeliveryMetodDimension',
			'type'  => 'str',
			'value' => '3'
		],
		[
			'group' => 'blaMatomo_CustomDimensions',
			'name'  => 'blaMatomo_iDeliveryAddressDimension',
			'type'  => 'str',
			'value' => '4'
		],
		...
		[
			'group' => 'blaMatomo_Goals',
			'name'  => 'blaMatomo_iNewsletterOptinGoal',
			'type'  => 'str',
			'value' => '1'
		],
		[
			'group' => 'blaMatomo_Goals',
			'name'  => 'blaMatomo_iNewsletterSubscribedGoal',
			'type'  => 'str',
			'value' => '2'
		],
		[
			'group' => 'blaMatomo_Goals',
			'name'  => 'blaMatomo_iNewsletterUnsubscribedGoal',
			'type'  => 'str',
			'value' => '3'
		],
